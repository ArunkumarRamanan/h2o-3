...
def import_with_column_names_types():
    ...
    csvWithHeader = h2o.import_file(pyunit_utils.locate("smalldata/airlines/allyears2k_headers.csv"), header=1)
    allColnames = csvWithHeader.names
    allTypeDict = csvWithHeader.types
    pathHeader=pyunit_utils.locate("smalldata/airlines/allyears2k_headers.csv")
